...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[Update_Datix_Ref_ContributoryFactors]
...
with cte  
       ...
       FROM [Foundation].[dbo].[Datix_Ref_ContributoryFactors]
...
From [Foundation].[dbo].[Datix_Ref_ContributoryFactors] s
