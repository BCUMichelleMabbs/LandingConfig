...
-- =============================================
CREATE PROCEDURE [dbo].[Get_PAS_Data_Outpatients_East]
...
BEGIN
	...
	DECLARE @LastTreatmentDate AS DATE = (SELECT ISNULL(MAX(DateOfAppointment),'1 September 2020') FROM [Foundation].[dbo].[PAS_Data_Outpatients] WHERE Source ='Myrddin' )
