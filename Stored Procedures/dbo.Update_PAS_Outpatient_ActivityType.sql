...
CREATE Procedure [dbo].[Update_PAS_Outpatient_ActivityType]
...
from Foundation.dbo.PAS_Data_Outpatient a
...
inner join Foundation.dbo.PAS_Data_Outpatient  o on a.specialty = LEFT(o.AdmittingSpecialty,3) 
...
inner join Foundation.dbo.PAS_Data_Outpatient  o on a.localsubspecialty = RIGHT(o.AdmittingSpecialty,3) 
...
inner join Foundation.dbo.PAS_Data_Outpatient  o on a.combinedspecialty =o.AdmittingSpecialty

where Source = 'Myrddin'
AND  Load_GUID=@Load_GUID
update l
set activitytype = 'Nurse-Led' 
from Foundation.dbo.PAS_Data_Outpatient l
...
inner join Foundation.dbo.PAS_Data_Outpatient l on a.specialty = LEFT(l.AdmittingSpecialty,3)
...
inner join Foundation.dbo.PAS_Data_Outpatient l on a.LocalSubspecialty = RIGHT(l.AdmittingSpecialty,3)
where l.source = 'WPAS'
and   l.ActivityType is null
and	l.AppointmentDate >= '01 April 2016'
AND  Load_GUID=@Load_GUID
...
inner join Foundation.dbo.PAS_Data_Outpatient l on a.combinedspecialty = l.AdmittingSpecialty
where l.source = 'WPAS'
and   l.ActivityType is null
and	l.AppointmentDate >= '01 April 2016'
AND  Load_GUID=@Load_GUID
...
inner join Foundation.dbo.PAS_Data_Outpatient l
