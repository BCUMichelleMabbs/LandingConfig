...
CREATE PROCEDURE [dbo].[Get_PAS_Data_Waiters_Eastv222_PCTest1]
...
AD2.APPT_DIRECTIVE as ApptDirDescCode,
...
*/
	...
	from 
		...
		left join APPT_DIRECTIVE AD2 on wl.APPT_DIR_DESC = AD2.DESCRIPTION 
