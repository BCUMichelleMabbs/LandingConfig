...
-- =============================================
CREATE PROCEDURE [dbo].[Rule_Common_IsNullOrEmptyString]
	@DatasetId AS INT,
	@FieldId AS INT
...
BEGIN
    ...
    SET @SQL='SELECT * FROM Landing.dbo.'+@SystemName+'_'+@DatasetType+'_'+@DatasetName+' WHERE '+@FieldName+' IS NULL OR '+@FieldName+' ='''''
	print @SQL
