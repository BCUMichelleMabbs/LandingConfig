...
-- =============================================
CREATE PROCEDURE [dbo].[Rule_Common_DateInPast]
	@DatasetId AS INT,
	@FieldId AS INT
...
BEGIN
    ...
    SET @SQL='SELECT * FROM Landing.dbo.'+@SystemName+'_'+@DatasetType+'_'+@DatasetName+' WHERE CAST('+@FieldName+' AS DATE) < GetDate()'
