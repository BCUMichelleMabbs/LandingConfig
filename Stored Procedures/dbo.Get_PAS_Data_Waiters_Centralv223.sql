...
--              22/06/2021 Risk Stratification Data not in WPAS SP 
-- =============================================


CREATE PROCEDURE [dbo].[Get_PAS_Data_Waiters_Centralv223]
...
wl.ADMIT_METHOD AS AdmitMethod,
...
Null as IntendedManagementCode,
Null as DateReferralRequestReceived,
Null as DateOfReferral,
Null as ReferralReason,
Null as LocalReferralUrgncCode,
Null as LocalReferralPrityCode,
...
Null as EisQueryId,
Null as ElectiveAdmissionTypeCode,
Null as LocalWLTypeCode,
...
---EXEC(' Select * from REF_WAIT_LEN_VIEW_ENH (''21'', ''21 JUN 2021'' ,'''','''','''','''') ') AT [WPAS_Central] 
-- REF_WAIT_LEN_VIEW_ENH (''''21'''',''''' + @TodayDateText + ''''','''''''','''''''','''''''','''''''') as wl
