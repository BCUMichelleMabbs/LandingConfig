...
CREATE PROCEDURE [dbo].[Get_Common_Ref_PatientAlert_East]
...
--DECLARE @AlertStartDate as date = '01 January 2020'

DECLARE @AlertStartDate AS DATE = (SELECT ISNULL(MAX(DateStarted),'01 January 2010') FROM [Foundation].[dbo].[Common_Ref_PatientAlert] where Area = 'East')
