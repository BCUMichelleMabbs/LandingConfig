...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[Get_UnscheduledCare_Data_EDAttendanceEastSymphonyHourly]
...
set @LPIType=(select top 1 lkp_id from [BCUED\BCUED_DB].EMIS_SYM_BCU_Live.dbo.lookups where lkp_name = 'BCUE PMI Number')
