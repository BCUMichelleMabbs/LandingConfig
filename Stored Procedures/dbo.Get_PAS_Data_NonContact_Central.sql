...
-- =============================================
CREATE PROCEDURE [dbo].[Get_PAS_Data_NonContact_Central]
...
BEGIN
	...
	DECLARE @LastTreatmentDate AS DATE = (SELECT ISNULL(MAX(AppointmentDate),'1 January 2018') FROM [Foundation].[dbo].[PAS_Data_NonContact] WHERE Source ='WPAS' and AppointmentDate <> '2999-12-31' and AppointmentDate < CONVERT(date,getdate()))
