...
CREATE PROCEDURE [dbo].[Get_PAS_Data_Outpatients_West]
...
(select top 1 heoid.heorg_refno
...
nullif(rtrim(dbo.IS_GetRefValID(''NHS'',refrl.sorrf_refno)), '''') as [SourceOfReferral],
