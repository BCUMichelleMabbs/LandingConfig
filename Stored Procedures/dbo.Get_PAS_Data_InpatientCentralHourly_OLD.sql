...
CREATE PROCEDURE [dbo].[Get_PAS_Data_InpatientCentralHourly_OLD]
...
update #IPHourlyResults set PDD =

PredictedDischargeDate
from cte p 
inner join #IPHourlyResults r
...
update #IPHourlyResults set MFDDate =
...
update #IPHourlyResults set OPDD =
...
from #IPHourlyResults 
drop table #IPHourlyResults 
